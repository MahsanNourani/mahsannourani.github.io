    ...
    const about = (
      <div>
        ...
        <div className="text-justify">
          ...
          <p className="mb-2"></p>
          <hr className="mb-2" />
          <b>Interested in my research?</b> Come work with me and my collegues at <a href="https://roux.northeastern.edu/" className="title-blues link"><b>The Roux Institute</b></a>. I'm actively searching for Summer Interns and Postdoctoral Researchers to establish my lab. <b>Current Northeastern students</b>: I welcome the opportunity to discuss potential mentoring or advising. If you're interested in Human-Centered AI and related topics, let's chat!
